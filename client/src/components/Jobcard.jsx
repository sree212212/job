...
const Jobcard = ({job}) => {
  ...
  return (
    <div className='boeder p-6 shadow rounded'>
...
{job.level}
    ...
    <div className='mt-4 flex gap-4 text-sm'>
        <button onClick={()=>{navigate(`/apply-job/${job._id}`);scrollTo(0,0)}}className='bg-blue-600 text-white px-4 py-2 rouned'>apply now</button>
